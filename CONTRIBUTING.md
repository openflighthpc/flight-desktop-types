# Contributing to Flight Desktop Types

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Desktop Types? Welcome! Please read this
...
You can help Flight Desktop Types by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-desktop-types/issues?state=open)
...
If you find a bug - behaviour of Flight Desktop Types code or documentation
...
[GitHub issue tracker for Flight Desktop Types](https://github.com/openflighthpc/flight-desktop-types/issues/new)
to report the issue.
...
We want to improve the quality of Flight Desktop Types and good bug reports are
...
Flight Desktop Types is Open Source and comes without warranty.
...
Flight Desktop Types in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Desktop Types and really improve it. The more
...
applied to Flight Desktop Types itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-desktop-types). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Desktop Types developers also have their regular
